...
cl = LINETCR.LINE(EMjBClnWsKzAv6253VZ5.I7AJcrfysUIaxrqdad1azq.QsD4GvzLYWVnhNm2i9MzaAZhsxqNh2Lm/dPoTgcTJHA=)
cl.login(qr=True)
cl.loginResult()

ki = LINETCR.LINE(EM1ceezd5brBAZs3B2a9.XXGMV95UcfXy1c87p6Q1sq.vyJjaaPZHfVNNU0vgG770faLO1NFlP7D1xfP5BL+kBo=)
ki.login(qr=True)
ki.loginResult()

ki2 = LINETCR.LINE(EMeQ6Zx690zdmnvbxGR8.+Es3tzQcdLmg7lYXW5GFIa.pxuwRO5J1wxvARykY5Ynyi0MKdSxtrPvKoAAULD84G4=)
ki2.login(qr=True)
ki2.loginResult()
